...
context("Redis commands", function()
	...
	context("Commands operating on the key space", function()
		test("KEYS (client:keys)", function()
			...
			assert_table_values(table.values(client:keys("*")), table.keys(kvs_all))
			assert_table_values(table.values(client:keys("metavars:*")), table.keys(kvs_prefixed))
			assert_table_values(table.values(client:keys("a?a")), table.keys(kvs_unprefixed))
		end)
		...
		test("SCAN (client:scan)", function()
			if version:is("<", "2.8.0") then
				return
			end

			client:mset("scan:1", "1", "scan:2", "2", "scan:3", "3", "scan:4", "4")
	...
	context("Commands operating on the key space - SORT", function()
		...
		before(function()
			...
			for _, v in ipairs(list01_values) do
				client:rpush(list01, v)
			end

			list02, list02_values = "list02", { "1", "10", "2", "20", "3", "30" }
			for _, v in ipairs(list02_values) do
				client:rpush(list02, v)
			end
		end)
	...
	context("Commands operating on string values", function()
		...
		test("SETEX (client:setex)", function()
			...
			assert_error(function()
				client:setex("hoge", 2.5, "piyo")
			end)
			assert_error(function()
				client:setex("hoge", 0, "piyo")
			end)
			assert_error(function()
				client:setex("hoge", -10, "piyo")
			end)
		end)
		...
		test("PSETEX (client:psetex)", function()
			...
			assert_error(function()
				client:psetex("hoge", 2.5, "piyo")
			end)
			assert_error(function()
				client:psetex("hoge", 0, "piyo")
			end)
			assert_error(function()
				client:psetex("hoge", -10, "piyo")
			end)
		end)
	...
	context("Commands operating on sets", function()
		...
		test("SUNION (client:sunion)", function()
			...
			assert_table_values(client:sunion("setA", "setB"), { "0", "1", "10", "2", "3", "4", "5", "6", "9" })
		...
		test("SUNIONSTORE (client:sunionstore)", function()
			...
			assert_table_values(client:smembers("setC"), { "0", "1", "10", "2", "3", "4", "5", "6", "9" })
	...
	context("Commands operating on zsets", function()
		...
		test("ZRANGEBYSCORE (client:zrangebyscore)", function()
			...
			assert_table_values(client:zrangebyscore("zset", 10, 20, { limit = { 1, 2 } }), { "d", "e" })
		...
		test("ZREVRANGEBYSCORE (client:zrevrangebyscore)", function()
			...
			assert_table_values(client:zrevrangebyscore("zset", 20, 10, { limit = { 1, 2 } }), { "d", "c" })
		...
		test("ZINTERSTORE (client:zinterstore)", function()
			...
			assert_table_values(client:zrange("zsetc", 0, -1, "withscores"), { { "b", "3" }, { "c", "5" } })
			...
			assert_table_values(client:zrange("zsetc", 0, -1, "withscores"), { { "b", "7" }, { "c", "12" } })

			-- with AGGREGATE (min)
			local opts = { aggregate = "min" }
			assert_equal(client:zinterstore("zsetc", 2, "zseta", "zsetb", opts), 2)
			assert_table_values(client:zrange("zsetc", 0, -1, "withscores"), { { "b", "1" }, { "c", "2" } })

			-- with AGGREGATE (max)
			local opts = { aggregate = "max" }
			assert_equal(client:zinterstore("zsetc", 2, "zseta", "zsetb", opts), 2)
			assert_table_values(client:zrange("zsetc", 0, -1, "withscores"), { { "b", "2" }, { "c", "3" } })
		...
		test("ZSCAN (client:zscan)", function()
			...
			client:zadd("key:zset", 1, "member:1st", 2, "member:2nd", 3, "member:3rd", 4, "member:4th")
